...
function ForgotPassword() {
  ...
  useEffect(() => {
    setIsDemo(import.meta.env.VITE_IS_DEMO === "true");
  }, []);
  ...
  const handleSubmit = async (e) => {
    ...
    const myData = {
      data: {
        ...
        attributes: {
          redirect_url: `${import.meta.env.VITE_URL}/auth/reset-password`,
          ...input,
        },
      },
    };
      ...
      <Card>
        ...
        >
          ...
          <MDTypography display="block" variant="button" color="white" my={1}>
            Recibiras un Coreo Electrónico en un maximo de 60 segundos.
          </MDTypography>
        </MDBox>
